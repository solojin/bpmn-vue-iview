  ...
  <div>
    <x-form ref="xForm" v-model="formData" :config="formConfig">
      <template #executionListener>
        <Badge :value="executionListenerLength">
          <Button size="small" @click="dialogName = 'executionListenerDialog'">编辑</Button>
        </Badge>
      </template>
      <template #taskListener>
        <Badge :value="taskListenerLength">
          <Button size="small" @click="dialogName = 'taskListenerDialog'">编辑</Button>
        </Badge>
      </template>
      <template #multiInstance>
        <Badge :is-dot="hasMultiInstance">
          <Button size="small" @click="dialogName = 'multiInstanceDialog'">编辑</Button>
        </Badge>
      </template>
    </x-form>
